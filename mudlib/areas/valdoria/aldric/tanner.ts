...
export class Tanner extends NPC {
  constructor() {
    super();
    this.name = 'Tanner Gorik';
    this.shortDesc = 'Tanner Gorik';
    this.longDesc = `Tanner Gorik is a weathered man with powerful forearms developed from
...
his face - clearly, he's running low on quality materials.`;
    ...
    this.chatChance = 10;
    this.chats = [
      { message: 'examines a piece of leather critically.', type: 'emote' },
      { message: 'Wolf pelts make the finest leather. Tough but supple.', type: 'say' },
      { message: 'dips his hands in a vat and wrings out a hide.', type: 'emote' },
      { message: 'tests the edge of a fleshing knife with his thumb.', type: 'emote' },
      { message: 'The wolves in the eastern forest have the best pelts.', type: 'say' },
    ];
    this.responses = [
      { pattern: 'hello|hi|greetings|hey', response: 'Greetings, ${speaker.name || \'traveler\'}. Looking for leather goods, or perhaps something else?', type: 'say' },
      { pattern: 'wolf|pelt|hunt|leather|material|supply', response: 'Ah, you\'ve noticed my predicament. I\'m running dangerously low on wolf pelts - they make the finest leather, you see. The wolves in the forest east of town would provide excellent materials, but they hunt in packs and I\'m no fighter.', type: 'say' },
      { pattern: 'buy|goods|belt|armor|boots', response: 'gestures at his displayed wares. "Fine leather goods, all hand-crafted. But I warn you - with supplies running low, prices may rise soon. Unless someone can help with that..."', type: 'emote' },
      { pattern: 'forest|east|danger|pack', response: 'nods grimly. "The forest wolves are cunning beasts. They hunt in packs of eight or more. You\'d need to be skilled with a blade to survive an encounter. But the pelts... ah, the pelts are worth the risk."', type: 'emote' },
      { pattern: 'reward|pay|gold', response: 'Seventy-five gold for a proper batch of wolf pelts - at least five good ones. Plus I\'d throw in a piece of fine leatherwork of your choosing. That\'s a fair deal for honest work.', type: 'say' },
      { pattern: 'thank|thanks', response: 'nods and returns to his work.', type: 'emote' },
      { pattern: 'quest', response: 'rubs his chin thoughtfully. "If you\'re willing to hunt some wolves and bring me their pelts, type \'quest accept\'. I\'ll make it worth your while."', type: 'emote' },
    ];
