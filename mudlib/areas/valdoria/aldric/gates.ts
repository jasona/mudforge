 ...
 * Town Gates
 *
 * Generated by Area Builder on 2026-01-25T15:43:48.778Z
 * Area: Town of Aldric (valdoria:aldric)
 */

import { Room } from '../../../lib/std.js';

export class Gates extends Room {
  constructor() {
    super();
...
those arriving on horseback. The bustle of the town center lies to the {green}north{/}.`;
    this.setMapCoordinates({ x: 2, y: 4, z: 0, area: '/areas/valdoria/aldric' });
  ...
  private setupRoom(): void {
    // Exits
    this.addExit('north', '/areas/valdoria/aldric/room_5_5_0');
