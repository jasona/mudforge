 ...
 * The Rusty Blade
 *
 * Generated by Area Builder on 2026-01-25T15:43:48.780Z
...
export class Pub extends Room {
  constructor() {
    super();
    this.shortDesc = 'The Rusty Blade';
...
private negotiations take place.`;
    this.setMapCoordinates({ x: 0, y: 3, z: 0, area: '/areas/valdoria/aldric' });
  ...
  private setupRoom(): void {
    // Exits
    this.addExit('north', '/areas/valdoria/aldric/room_3_4_0');
