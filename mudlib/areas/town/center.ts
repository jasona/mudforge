...
export class CenterOfTown extends Room {
  constructor() {
    ...
    this.longDesc = `You stand in the heart of a bustling medieval town square. Cobblestones worn
smooth by countless feet spread out in all directions, and a magnificent stone
fountain dominates the center, its crystal waters catching the sunlight.

Merchants hawk their wares from colorful stalls lining the square's edges, their
voices mingling with the clatter of horse hooves and the chatter of townsfolk.
The aroma of fresh bread wafts from a nearby bakery, competing with the earthy
scent of the blacksmith's forge.

To the north, the imposing walls of the castle rise above the rooftops. An old
tavern with a weathered sign creaks in the breeze to the east. The western road
leads toward the merchant district, while southward lies the town gates and the
wilderness beyond.

A town crier stands near the fountain, occasionally announcing the day's news to
